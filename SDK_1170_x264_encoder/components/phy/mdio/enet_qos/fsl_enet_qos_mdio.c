...
/*!
 * @brief Get the ENET QOS instance from peripheral base address.
 *
 * @param base ENET QOS peripheral base address.
 * @return ENET QOS instance.
 */
extern uint32_t ENET_QOS_GetInstance(ENET_QOS_Type *base);
...
extern clock_ip_name_t s_enetqosClock[1];
