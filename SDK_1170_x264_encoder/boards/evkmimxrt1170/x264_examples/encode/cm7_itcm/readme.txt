...
Board settings
==============
1. Please make sure the R136 is welded for card detection through GPIO.

Note: Since the GPIO CD pin is conflict with the ENET MDC pin on board, so once R136 is welded for sdcard detection, then ENET may not
work properly.
