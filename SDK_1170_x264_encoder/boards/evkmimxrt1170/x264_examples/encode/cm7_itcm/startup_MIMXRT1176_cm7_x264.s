...
//[11:56 AM] Crist Xu
//    
//.equ BANK_CFG_0_ADDR, 0x400e4044
//.equ BANK_CFG_1_ADDR, 0x400e4048
//.equ BANK_CFG_0, 0xAAAA
//.equ BANK_CFG_1, 0xFFAA
//.equ BANK_CFG_SEL, 0x400e4040
//.equ CFG_SEL, 1<<2
//
//
//    .thumb_func
//    .align 2
//    .type    Config_Flexram, %function
Config_Flexram
    /* 128K itcm(32*4), 384K dtcm(12*4) */
    /* block1 set */
    ldr r0,=0x400E4044
    ldr r1, [r0]
    ldr r2, =0xFFFF
    bfi r1, r2, #0, #16   // 11, itcm, 10, dtcm, 01 ocram, 8*dtcm
    str r1, [r0]
    /* block2 set */
    ldr r0,=0x400E4048
    ldr r1, [r0]
    ldr r2, =0xFFFA
    bfi r1, r2, #0, #16   // 4*dtcm, 4*dtcm
    str r1, [r0]
    /*   CFG Sel  */
    ldr r0,=0x400E4040
    ldr r1, [r0]
    orr r1, r1, #2    // use FLEXRAM_BANK_CFG to configure
    str r1, [r0]
    dsb
    bx lr
