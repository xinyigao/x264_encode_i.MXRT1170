...
int x264_main( int argc, char **argv )
{
    x264_param_t param;
    cli_opt_t opt = {0};
    int ret = 0;
...
static int parse( int argc, char **argv, x264_param_t *param, cli_opt_t *opt )
{
    ...
    output_filename = "test.h264";    //Ð´ËÀ
    // input_filename = "bigbuckbunny_480x272.yuv";
   // input_filename = "formen_352x288.yuv";
    input_filename = "test.yuv";
...
#define EXAMPLE_LED_GPIO_PIN 0U
static int encode( x264_param_t *param, cli_opt_t *opt )
{
    x264_t *h = NULL;
    x264_picture_t pic;
